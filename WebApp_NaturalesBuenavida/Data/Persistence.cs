...
namespace Data
{
    ...
    {
        // MySqlConnection es una clase que representa una conexión a una base de da-tos MySQL.
        ...
        // Devuelve un objeto MySqlConnection que representa la conexión estable-cida.
        public MySqlConnection openConnection()
        {
            ...
            {
                // En caso de error, se captura la excepción y se muestra la in-formación de la excepción en la consola.
                e.ToString();
