...
<asp:Content ID="BodyContent" ContentPlaceHolderID="ContentPlaceHolderLogin" runat="server">
    ...
    <style>
        body {
            background: url('resources/image/fondo.png') no-repeat center center fixed, linear-gradient(0.46deg, rgba(206, 102, 0, 0.6) 0.4%, rgba(206, 102, 0, 0.741712) 15.28%, #CE6600 45.54%, #CE6600 83.23%);
    ...
    <div class="d-flex flex-column min-vh-100">
        <div class="my-auto d-flex flex-column flex-md-row justify-content-center align-items-center">
            ...
            <div class="text-center text-white m-4">
                ...
                <p class="fst-italic text-center">Naturales Buenavida,<br />mientras comes alargas tu vida.</p>
            </div>
         ...
         <!-- Footer -->
         <footer class="bg-dark text-white text-center py-3 mt-5 text-break">
